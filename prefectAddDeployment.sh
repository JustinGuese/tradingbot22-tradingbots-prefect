...
for file in $ALLFILES; do
    ...
    prefect deployment build "$file:mainFlow" -n $filename -q docker-caprover-container-sb -sb github/tradingbot-repo -p docker-caprover-container-sb --cron "$cron" -ib docker-container/docker-container-execution
